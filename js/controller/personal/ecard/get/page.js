define(['modal', 'util/block', 'core', 'util/pageNav', 'layer',
    'build/personal/ecard/get/main', 'build/personal/ecard/get/table', 'build/personal/ecard/get/filter'], 
    ...
    return function(){
        ...
        var getList = function(index) {
            ...
            modal.run('ecard.list', param)
                .then(function(data) {
                    ...
                    pageNav.create("#ecardget-pagenav", option);
                }, function(err) {  
                    console.log(err);
                })
        }
        ...
        $("#page").html(main_tpl());
        $("#ecardget-filter").html(filter_tpl());
        ...
        //tab选择
        $("#ecardget-filter .status").on("click","a",function(e) {
