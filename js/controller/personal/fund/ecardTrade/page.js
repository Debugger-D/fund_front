define(['modal', 'util/block', 'core', 'util/pageNav',
	'build/personal/fund/ecardTrade/main', 'build/personal/fund/ecardTrade/table', 'build/personal/fund/ecardTrade/filter'], 
    ...
    return function(){   
        ...
        var getList = function(index) {
            ...
            modal.run('ecard.pageTradeList', param)
                .then(function(data) {
                    render(data);
                    // 这里要改变 option
                    ...
                    pageNav.create("#ecardTrade-pagenav", option);
                }, function(err) {  
                    console.log(err);
                })
        }
        ...
        $("#page").html(main_tpl());
	    $("#ecardTrade-filter").html(filter_tpl());
        ...
        //tab选择
        $("#ecardTrade-filter .time").on("click","a",function(e) {
